...
特殊事件包括幸运送灯、火车连奖、大三元、小三元和累积彩金。特殊事件会逐灯跑动后结算。中奖所得先进入 WIN，可转至 CREDIT，也可把 CREDIT 追加到本轮比倍筹码。比倍小为 1–7，大为 8–14，最多连续五次。

游戏状态、彩金池和声音设置均保存在当前浏览器。总资金归零时，系统补贴 100 模拟 USD。
