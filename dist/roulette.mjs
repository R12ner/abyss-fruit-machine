...
roulette.innerHTML=`
  ...
  <dialog id="dealer-dialog" class="dealer-dialog"><button type="button" class="close dealer-close" aria-label="关闭">×</button><span class="rules-kicker">DEALER PREFERENCE</span><h2>与荷官对话</h2><p>赔付时请优先给我：</p><div id="dealer-chip-options" class="dealer-chip-options"></div><section class="dealer-service"><div><strong>赔付区整理</strong><span>按当前偏好等值换筹码</span></div><button type="button" id="dealer-exchange">整理筹码</button></section><section class="dealer-tip"><div><strong>给荷官小费</strong><span id="dealer-tip-total"></span></div><small>小费越大，偶遇内幕彩蛋的概率越高。</small><div id="dealer-tip-options" class="dealer-tip-options"></div></section><aside id="dealer-intel" class="dealer-intel" hidden><span>♣ INSIDER TIP · 下一局有效</span><strong id="dealer-intel-message"></strong></aside><p id="dealer-message" aria-live="polite">荷官：请告诉我您的偏好。</p><button type="button" class="dealer-done">完成</button></dialog>`;
...
function spin(){
  ...
  try{result=state.dealerIntel?.result??secureNumber(37)}catch{setStatus('安全随机数暂不可用，本轮未扣款');return}
